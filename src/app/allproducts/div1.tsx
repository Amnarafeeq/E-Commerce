...
const Div1 = ({ img1, img2, img3, para, btnText, link }: IProductsProps) => {
  return (
    <div className="bg--500 p-2 w-[80%] mx-auto lg:h-[100vh] flex max-md:flex-col md:justify-between my-6 border- ">
      <div className="sm:w-[60%] bg--400 h-full    flex flex-col justify-evenly items-center gap-y-3 my-2 ">
        ...
        <div className="w-[90%] h-[45%] bg--300 flex justify-between">
          <Image width={400} height={300} src={img2} alt="" className="w-[58%]  p-2 bg-gray-600" />
          <Image width={400} height={300} src={img3} alt="" className="w-[38%]  p-2 bg-slate-200" />
        </div>
      </div>
